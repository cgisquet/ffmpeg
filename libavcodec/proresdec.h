...
typedef struct {
    ...
    int first_field;
    int alpha_info;
    // Forward declaration used to avoid header include, and mismatched definition
    void (*unpack_alpha)(struct BitstreamContextBE *gb, uint16_t *dst, int num_coeffs, const int num_bits);
