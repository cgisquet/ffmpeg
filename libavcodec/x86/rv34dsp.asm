...
cglobal rv34_idct_add, 3,3,0, d, s, b
    ...
    mova         [bq+ 2*8], mm1
    mova         [bq+ 3*8], mm1
    COL_TRANSFORM     [dq], mm0, [pw_col_coeffs+ 0], [pw_col_coeffs+ 8], 0
    mova               mm0, [pw_col_coeffs+ 0]
    COL_TRANSFORM  [dq+sq], mm4, mm0, [pw_col_coeffs+ 8], 0
    mova               mm4, [pw_col_coeffs+ 8]
    lea                 dq, [dq + 2*sq]
    COL_TRANSFORM     [dq], mm6, mm0, mm4, 0
    COL_TRANSFORM  [dq+sq], mm7, mm0, mm4, 0
    ret

cglobal rv34_idct_noround, 1,1,0, b
    ROW_TRANSFORM       bq
    movq               mm5, [pw_col_coeffs2+ 0]
    COL_TRANSFORM  [bq+ 0], mm0, mm5, [pw_col_coeffs2+ 8], 1
    mova               mm0, [pw_col_coeffs2+ 8]
    COL_TRANSFORM  [bq+ 8], mm4, mm5, mm0, 1
    COL_TRANSFORM  [bq+16], mm6, mm5, mm0, 1
    COL_TRANSFORM  [bq+24], mm7, mm5, mm0, 1
    ret
